...
##PENSE-BETE
#//https://geomatik.it-bouchet.fr/API/test_api.php?action=get_time_depcom&start=78126&stop=75111&key=e65b06cc5857bb51472f405d80
	...
	if (col_name_src[0:3] == "NB_"): #Si unr colonne commene par NB_, on continu le traitement
		...
		with tqdm(total=len(df)) as pbar:
			...
			for index, row in df.iterrows():
                ...
                # adr = "https://geomatik.it-bouchet.fr/api/?action=get_time_depcom&start=78126&stop=75111&key="
				try:
